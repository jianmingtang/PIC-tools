...
class Figure2D(Figure):
	...
	def draw_one(self, name, Lx, Ly, X, Y, fZ, U=None, V=None):
		""" Draw a single plot
			name: title of the plot
			X, Y: 1D axes data
	...
	def draw_quad(self, name, Lx, Ly, X, Y, fZ, U=None, V=None):
		""" Draw 4 subplots
...
class Figure1D(Figure):
	...
	def draw_one(self, name, Lx, Ly, X, Y):
		""" Draw a single plot
			name: title of the plot
			X, Y: 1D data
		"""
	...
	def draw_quad(self, name, Lx, Ly, X, Y):
		""" Draw 4 subplots
			name: main title of the plots
			X, Y: 1D data
		"""
